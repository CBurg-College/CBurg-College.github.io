const apiKey = "KTSWPMNXMTF3ICCN";	// Read Key only needed in case of a private channel
const channelId = "2936917";		// Channel number of 'Kweekbakje 1'
const points = 1;					// Number of data points requested
const url = `https://api.thingspeak.com/channels/${channelId}/feeds.json?api_key=${apiKey}&results=${points}`;
